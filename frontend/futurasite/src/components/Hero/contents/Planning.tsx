...
function Planning() {
  return (
    <section className="container mx-auto flex h-[650px] flex-col items-center justify-center py-10 bg-gradient-to-br from-blue-50 via-gray-100 to-blue-100 dark:bg-gradient-to-br dark:from-indigo-900 dark:via-purple-800 dark:to-indigo-700 rounded-lg shadow-xl md:h-[500px] px-6 lg:px-16">
