...
function Synergy() {
  return (
    <section className="container mx-auto flex flex-col items-center justify-center py-10 bg-gradient-to-br from-blue-50 via-gray-100 to-blue-100 dark:bg-gradient-to-br dark:from-gray-900 dark:via-gray-800 dark:to-gray-700 rounded-lg shadow-xl md:h-[500px] px-6 lg:px-16">
      <div className="grid grid-cols-1 items-center gap-8 text-gray-800 dark:text-white md:grid-cols-2 md:gap-12">
        ...
        >
          <img
            ...
            className="max-w-full w-full h-auto max-h-[350px] object-contain transform hover:scale-105 transition duration-300 hover:drop-shadow-lg dark:drop-shadow-md rounded-lg"
          />
        </div>
      </div>
    </section>
